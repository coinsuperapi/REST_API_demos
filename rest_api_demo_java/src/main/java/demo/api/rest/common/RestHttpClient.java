...
public class RestHttpClient {
     ...
     * @return
     */
    public static String post(String serverUrl, String realData, int connectTimeout, int readTimeout, String charset) throws NoSuchAlgorithmException, KeyManagementException, IOException {
